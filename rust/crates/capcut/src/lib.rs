...
use materials::{
    collect_media, collect_segments, collect_speeds, collect_stickers, collect_texts, RawDraft,
};
pub use materials::{LocalAsset, Media, MediaKind, Segment, Sticker, TextMaterial};
use template::{
    CanvasSpec, FpsSpec, SlotKind, TemplateManifest, TemplateSlot, TEMPLATE_FORMAT_VERSION,
};
