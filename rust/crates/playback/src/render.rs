...
use cutix_project::{color::parse_to_linear_rgba, Project};
...
use crate::resolve::{
    bitmap_quad, contain_scale, effect_pass_groups, element_local_time, is_visible,
    parse_blend_mode, quad_transform, raster_params, resolved_crop, resolved_opacity,
    resolved_transform, text_transform, track_hidden, visual_params, RasterSource,
};
...
mod stroke_and_blur_tests {
    ...
    fn a_zero_width_or_transparent_stroke_is_not_drawn() {
        ...
        assert!(mask_stroke(&mask_with(serde_json::json!({
            "strokeWidth": 4.0,
