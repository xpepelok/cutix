pub mod studio {
    ...
    pub const TAGS: &str = "#tags-container input, #tags-container textarea, ytcp-form-input-container#tags-container [contenteditable], [aria-label=\"Tags\"]";
    ...
    pub const CATEGORY_SELECT: &str = "ytcp-form-select#category ytcp-text-dropdown-trigger, #category-container ytcp-text-dropdown-trigger";
    ...
    pub const CONFIRM_DIALOG: &str = "ytcp-confirmation-dialog, ytcp-dialog[role=\"dialog\"], tp-yt-paper-dialog[role=\"dialog\"]";
    ...
    pub const PUBLISHED_DIALOG: &str = "ytcp-uploads-still-processing-dialog, ytcp-video-published-dialog, ytcp-uploads-review-dialog";
