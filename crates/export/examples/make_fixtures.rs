...
use cutix_export::{BackendFactory, VideoSpec, blit_centre, compute_contain_fit};
...
fn encode_clip(recipe: ClipRecipe<'_>) {
    let ClipRecipe {
        source,
        destination,
        width,
    ...
    let mut backend = OPENH264_MP4_FACTORY
        .create(
            ...
            VideoSpec {
                ...
                frame_rate,
                bitrate_bps,
                quality: cutix_export::ExportQuality::Medium,
            },
            None,
        )
    ...
    for index in 0..frames {
        ...
        blit_centre(
            cutix_export::RgbaFrame {
                pixels: &scaled,
                width: inner_width,
                height: inner_height,
            },
            cutix_export::RgbaFrameMut {
                pixels: &mut canvas,
                width,
                height,
            },
...
static OPENH264_MP4_FACTORY: &dyn BackendFactory = &cutix_export::OPENH264_MP4;
...
fn main() {
    ...
    encode_clip(ClipRecipe {
        source: &source,
        destination: &square,
        width: fixtures::SQUARE_CLIP_WIDTH,
        height: fixtures::SQUARE_CLIP_HEIGHT,
        frame_rate: FrameRate::FPS_25,
        frames: fixtures::SQUARE_CLIP_FRAMES,
        start_seconds: 24.0,
    ...
    encode_clip(ClipRecipe {
        source: &source,
        destination: &directory.join(fixtures::HD_CLIP),
        width: fixtures::HD_CLIP_WIDTH,
        height: fixtures::HD_CLIP_HEIGHT,
        frame_rate: FrameRate::FPS_50,
        frames: fixtures::HD_CLIP_FRAMES,
        start_seconds: 24.0,
