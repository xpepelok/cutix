...
pub use frame_rate::{FrameDuration, FrameRate};
pub use media_time::{
...
pub use speed_curve::{
    OutputDurationOptions, SourceTimeAtOptions, SpeedAtOptions, SpeedCurve, SpeedPoint,
    output_duration_for_source, source_time_at, speed_at,
};
pub use timecode::{
